...
pub(crate) fn extract_floats(s: &str) -> Result<(&str, &str), String> {
    take_while1(|c| c.is_ascii_digit() || c == '.', s, "Expected floats".to_string())
}
...
mod tests {
    ...
    #[test]
    fn extract_float() {
        assert_eq!(extract_floats("0.2"), Ok(("", "0.2")));
    }
